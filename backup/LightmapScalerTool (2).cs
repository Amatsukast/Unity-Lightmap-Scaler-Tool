...
public class LightmapScalerTool : EditorWindow
{
    ...
    private const float DefaultMinOccupancyRatio = 0.015f;
    ...
    private void OnGUI()
    {
        ...
        {
            minOccupancyRatio = EditorGUILayout.FloatField("最小占有率（指定）", minOccupancyRatio);
        }
    ...
    private void ResetToDefaults()
    {
        ...
        minOccupancyRatio = DefaultMinOccupancyRatio;
